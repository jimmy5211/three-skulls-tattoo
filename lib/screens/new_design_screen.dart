...
class _NewDesignScreenState extends State<NewDesignScreen> {
  ...
  // Presets de tamaño populares para tatuajes
  ...
  String get _dpiLabel {
    switch (_dpi) {
      case CanvasDpi.dpi72:
        return '72 DPI — Pantalla';
      case CanvasDpi.dpi150:
        return '150 DPI — Estándar';
      case CanvasDpi.dpi300:
        return '300 DPI — Impresión';
    }
  }
  ...
  String get _unitLabel {
    switch (_unit) {
      ...
      case CanvasUnit.mm:
        return 'mm';
      case CanvasUnit.inch:
        return 'in';
    }
  }

  // Convierte las dimensiones a píxeles según DPI
  int _toPixels(double value) {
    switch (_unit) {
      case CanvasUnit.px:
        return value.round();
      case CanvasUnit.cm:
        return (value * _dpiValue / 2.54).round();
      case CanvasUnit.mm:
        return (value * _dpiValue / 25.4).round();
      case CanvasUnit.inch:
        return (value * _dpiValue).round();
    }
  }
  ...
  void _createDesign() {
    ...
    // Pasar parámetros al canvas via extra
        ...
        children: [
          ...
          Row(
            children: CanvasUnit.values.map((unit) {
              ...
              final label = unit.name == 'inch' ? 'in' : unit.name;
              return Expanded(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color:
                  isActive ? AppTheme.accentRed : _borderColor,
              width: isActive ? 1.5 : 0.5,
            ),
          ),
          child: Row(
...
// ─── CHECKER PAINTER (fondo transparente) ─────────────────
