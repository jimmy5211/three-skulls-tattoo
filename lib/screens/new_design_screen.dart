...
class _NewDesignScreenState extends State<NewDesignScreen> {
  ...
  void _applyPreset(int index) {
    ...
    setState(() {
      ...
      // Ajustar orientación según preset
  ...
  // FIX: swap solo intercambia dimensiones, orientación se maneja aparte
  ...
  Widget _buildTopBar() {
    return Container(
      ...
      child: Row(
        children: [
          // FIX botón atrás: usa Navigator en lugar de WillPopScope
          GestureDetector(
  ...
  Widget _buildOrientationOption(
    ...
    return Expanded(
      child: GestureDetector(
        // FIX: siempre actualiza la orientación directamente
  ...
  Widget _buildBackgroundSection() {
    return _buildSection(
      ...
      child: Row(
        children: [
          // FIX: AbsorbPointer false + GestureDetector en el nivel correcto
          _buildBgOption(
