...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _downloadAndInstall(String url) async {
    // Pedir permiso para instalar apps desconocidas
    ...
    if (!installPermission.isGranted) {
        ...
        const SnackBar(
          ...
          content: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'Permite instalar apps desconocidas en Ajustes del sistema',
                  style: TextStyle(
                      fontFamily: 'Raleway',
                      color: AppTheme.textWhite,
                      fontSize: 12),
      ...
      // Abrir configuración del sistema para que el usuario active el permiso
