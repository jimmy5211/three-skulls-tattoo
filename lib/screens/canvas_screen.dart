...
void initState() {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSelectionOption(
                  Icons.auto_fix_high, 'Automático', SelectionMode.automatico),
              _buildSelectionOption(
                  Icons.gesture, 'Forma libre', SelectionMode.libre),
              _buildSelectionOption(
                  Icons.crop_square, 'Rectangular', SelectionMode.rectangular),
              _buildSelectionOption(
                  Icons.circle_outlined, 'Elipse', SelectionMode.elipse),
              Container(
                height: 0.5,
                color: _borderColor,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (isActive) ...[
              const SizedBox(width: 8),
              Icon(Icons.check, color: AppTheme.accentRed, size: 14),
            ],
          ],
        ),
      ),
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Column(
        ...
        children: [
          ...
          _buildSettingRow(Icons.invert_colors, 'Invertir selección',
          ...
          _buildSettingRow(Icons.content_copy_outlined, 'Copiar selección',
              'Copia el área seleccionada'),
          _buildSettingRow(Icons.cut_outlined, 'Cortar selección',
              'Corta el área seleccionada'),
          _buildSettingRow(Icons.delete_outline, 'Limpiar selección',
  ...
  Widget _buildCategoryView() {
    final categoryBrushes =
        _brushes.where((b) => b.category == _selectedCategory).toList();
