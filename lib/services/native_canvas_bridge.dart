...
class NativeCanvasBridge {
  ...
  /// Stamp directo sin interpolación — para el espejo del borrador desde Dart.
  ...
  Future<void> setSymmetry(bool enabled, {int axis = 0}) =>
      _ch.invokeMethod('setSymmetry', {'enabled': enabled, 'axis': axis});
